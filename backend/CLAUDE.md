...
## Stack
- **Backend:** NestJS, Fastify, TypesScript, Drizzle ORM, Zod, vitest, swc compiler, Passport Auth, Date FNS
- **Banco:** PostgreSQL
- **Storage:** AWS S3
- **Emails:** Resend API
- **Pagamentos:** Stripe
...
BackEnd:
 ...
 - target always the same coverage percentage
