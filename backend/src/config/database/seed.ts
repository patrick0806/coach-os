...
async function seed(db: ReturnType<typeof drizzle>) {
  ...
  try {
    ...
    const globalExercises = [
      // Chest
      { name: "Supino Reto com Barra", muscleGroup: MuscleGroup.PEITORAL, description: "Exercício composto para peitoral maior", instructions: "Deite no banco, segure a barra na largura dos ombros, desça até o peito e empurre de volta." },
      { name: "Supino Inclinado com Halteres", muscleGroup: MuscleGroup.PEITORAL, description: "Foco na parte superior do peitoral", instructions: "No banco inclinado a 30-45°, pressione os halteres para cima alinhados com o peito." },
      { name: "Crucifixo com Halteres", muscleGroup: MuscleGroup.PEITORAL, description: "Isolamento do peitoral", instructions: "Deite no banco, abra os braços lateralmente com leve flexão dos cotovelos e retorne." },
      { name: "Flexão de Braço", muscleGroup: MuscleGroup.PEITORAL, description: "Exercício com peso corporal para peitoral", instructions: "Mãos na largura dos ombros, desça o corpo até o peito quase tocar o chão." },

      // Back
      { name: "Puxada na Barra Fixa", muscleGroup: MuscleGroup.COSTAS, description: "Exercício composto para dorsal", instructions: "Segure a barra pronada, puxe o corpo até o queixo ultrapassar a barra." },
      { name: "Remada Curvada com Barra", muscleGroup: MuscleGroup.COSTAS, description: "Desenvolvimento da espessura das costas", instructions: "Incline o tronco a 45°, puxe a barra em direção ao abdômen." },
      { name: "Puxada no Pulley", muscleGroup: MuscleGroup.COSTAS, description: "Variação da puxada para dorsal", instructions: "Segure a barra do pulley, puxe em direção ao peito mantendo a postura." },
      { name: "Remada Unilateral com Halter", muscleGroup: MuscleGroup.COSTAS, description: "Remada para correção de assimetrias", instructions: "Apoie um joelho e mão no banco, puxe o halter em direção ao quadril." },

      // Legs
      { name: "Agachamento Livre", muscleGroup: MuscleGroup.PERNAS, description: "Exercício fundamental para membros inferiores", instructions: "Barra nos trapézios, desça até as coxas ficarem paralelas ao chão." },
      { name: "Leg Press 45°", muscleGroup: MuscleGroup.PERNAS, description: "Exercício composto na máquina", instructions: "Posicione os pés na plataforma na largura dos ombros e empurre." },
      { name: "Cadeira Extensora", muscleGroup: MuscleGroup.PERNAS, description: "Isolamento do quadríceps", instructions: "Estenda as pernas completamente e retorne de forma controlada." },
      { name: "Mesa Flexora", muscleGroup: MuscleGroup.PERNAS, description: "Isolamento dos isquiotibiais", instructions: "Deite de bruços e flexione as pernas trazendo o calcanhar em direção ao glúteo." },
      { name: "Stiff", muscleGroup: MuscleGroup.PERNAS, description: "Posterior de coxa e glúteos", instructions: "Com a barra, incline o tronco mantendo as pernas semi-estendidas." },

      // Shoulders
      { name: "Desenvolvimento com Halteres", muscleGroup: MuscleGroup.OMBROS, description: "Exercício composto para deltoides", instructions: "Sentado, pressione os halteres acima da cabeça." },
      { name: "Elevação Lateral", muscleGroup: MuscleGroup.OMBROS, description: "Isolamento do deltoide lateral", instructions: "Em pé, eleve os halteres lateralmente até a altura dos ombros." },
      { name: "Elevação Frontal", muscleGroup: MuscleGroup.OMBROS, description: "Isolamento do deltoide anterior", instructions: "Em pé, eleve os halteres à frente até a altura dos ombros." },

      // Arms
      { name: "Rosca Direta com Barra", muscleGroup: MuscleGroup.BICEPS, description: "Exercício básico para bíceps", instructions: "Em pé, flexione os braços trazendo a barra até os ombros." },
      { name: "Rosca Alternada com Halteres", muscleGroup: MuscleGroup.BICEPS, description: "Trabalho unilateral dos bíceps", instructions: "Em pé, flexione um braço de cada vez com supinação." },
      { name: "Tríceps Pulley", muscleGroup: MuscleGroup.TRICEPS, description: "Isolamento do tríceps", instructions: "Na polia alta, estenda os braços mantendo os cotovelos junto ao corpo." },
      { name: "Tríceps Testa", muscleGroup: MuscleGroup.TRICEPS, description: "Exercício para cabeça longa do tríceps", instructions: "Deitado, desça a barra/halteres até a testa e estenda." },

      // Core
      { name: "Prancha Abdominal", muscleGroup: MuscleGroup.ABDOMEN, description: "Estabilização do core", instructions: "Apoie antebraços e pés, mantenha o corpo reto por tempo determinado." },
      { name: "Abdominal Crunch", muscleGroup: MuscleGroup.ABDOMEN, description: "Flexão de tronco básica", instructions: "Deite com joelhos flexionados, eleve os ombros do chão contraindo o abdômen." },

      // Glutes
      { name: "Hip Thrust", muscleGroup: MuscleGroup.GLUTEOS, description: "Exercício principal para glúteos", instructions: "Apoie as costas no banco, empurre o quadril para cima com a barra." },
      { name: "Abdução de Quadril na Máquina", muscleGroup: MuscleGroup.GLUTEOS, description: "Isolamento do glúteo médio", instructions: "Sentado na máquina, abra as pernas contra a resistência." },

      // Calves
      { name: "Panturrilha em Pé", muscleGroup: MuscleGroup.PANTURRILHA, description: "Exercício para gastrocnêmio", instructions: "Em pé na máquina, eleve os calcanhares o máximo possível." },
      { name: "Panturrilha Sentado", muscleGroup: MuscleGroup.PANTURRILHA, description: "Exercício para sóleo", instructions: "Sentado na máquina, eleve os calcanhares de forma controlada." },
    ];
