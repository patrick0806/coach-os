...
describe("DeactivateByProgramUseCase", () => {
  ...
  it("should deactivate recurring slots linked to a program", async () => {
  ...
  it("should return 0 when no slots are linked", async () => {
  ...
  it("should not deactivate already inactive slots", async () => {
    repository.deactivateByProgramId.mockResolvedValue(0);
