...
| 2 | Criar modulo de enums no backend | - | Nenhuma | - |
| 3 | MuscleGroup → Enum (back + front + migration) | - | #2 | - |
| 4 | AttendanceType → Enum (back + front) | - | #2 | - |
...
| 9 | Testes behavior: studentPortal | - | Nenhuma | - |
